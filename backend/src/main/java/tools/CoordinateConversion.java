...
public class CoordinateConversion
{
  ...
  public static double[] utm2LatLon(int longZone, String latZone, double easting, double northing)
  {
	  if(longZone == 0) longZone = 32;
	  if(latZone.equals("")) latZone = "v";
    UTM2LatLon c = new UTM2LatLon();
    return c.convertUTMToLatLong(longZone,latZone,easting,northing);
  }
  ...
  private static class UTM2LatLon
  {
    ...
    public double[] convertUTMToLatLong(int longZone, String latZone, double easting, double northing)
    {
      double[] latlon = { 0.0, 0.0 };
      zone = longZone;
